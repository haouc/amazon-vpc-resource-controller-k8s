...
func (in *CNINodeStatus) DeepCopyInto(out *CNINodeStatus) {
	*out = *in
	if in.BranchENIs != nil {
		in, out := &in.BranchENIs, &out.BranchENIs
		*out = make([]WarmBranchENI, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WarmBranchENI) DeepCopyInto(out *WarmBranchENI) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WarmBranchENI.
func (in *WarmBranchENI) DeepCopy() *WarmBranchENI {
	if in == nil {
		return nil
	}
	out := new(WarmBranchENI)
	in.DeepCopyInto(out)
	return out
}
