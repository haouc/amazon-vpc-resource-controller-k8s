...
// UpdateCNINode mocks base method.
func (m *MockK8sWrapper) UpdateCNINode(arg0 *v10.Node, arg1, arg2 *v1alpha10.CNINode) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateCNINode", arg0, arg1, arg2)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdateCNINode indicates an expected call of UpdateCNINode.
func (mr *MockK8sWrapperMockRecorder) UpdateCNINode(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateCNINode", reflect.TypeOf((*MockK8sWrapper)(nil).UpdateCNINode), arg0, arg1, arg2)
}
